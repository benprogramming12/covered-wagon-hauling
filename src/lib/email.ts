...
// The site and all payment features work without this.
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <p>Your quote is ready! To confirm your booking on <strong>${scheduledDate}</strong>,
        please pay the 50% deposit of <strong>$${depositAmount.toFixed(2)}</strong>.</p>
        <p><a href="${paymentUrl}" style="background:#C9960A;color:#fff;padding:12px 24px;
